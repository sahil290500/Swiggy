  ...
  return (
    <div className="bg-slate-300 h-auto">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex pt-9 justify-between p-4">
          <div className=" font-semibold mr-5">
            <Logo />© 2024 Swiggy Limited
          </div>
          <div className="">
          ...
          <div className="">
            <p className="text-[20px] font-bold">Contact us</p>
            <ul>
              <li>Customer Care</li>
              <li>Support</li>
              <li>Press Inquiries</li>
              <li>FAQs</li>
              <p className="text-[20px] font-bold pt-3">Legal</p>
          ...
          <div className="">
            <p className="text-[20px] font-bold">Available in:</p>
            <ul>
              <li>United States</li>
          ...
          <div className="">
            <p className="text-[20px] font-bold">Life at Swiggy</p>
            <ul>
              <li>Explore with Swiggy</li>
              <li>Earn rewards</li>
              <li>Help others find a perfect place</li>
              <li>Stay informed about promotions</li>
            </ul>
            <p className="text-[20px] font-bold pt-3 pb-2">Social Links</p>
        ...
        <hr className="my-6 border-[2px] border-black" />
        <div className="flex flex-auto flex-row">
          <div className="font-bold text-[25px] pb-7 flex gap-2 pt-4">
